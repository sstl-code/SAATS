...
class AuditActiveTab extends StatefulWidget {
  const AuditActiveTab({Key? key}) : super(key: key);

  @override
  State<AuditActiveTab> createState() => _AuditActiveTabState();
}

class _AuditActiveTabState extends State<AuditActiveTab> {
  ...
  Widget build(BuildContext context) {
    return Consumer<AssetAuditProvider>(
        ...
        return provider.isLoading
            ...
            : SingleChildScrollView(
                ...
                child: ListView.separated(
                  ...
                  shrinkWrap: true,
                  itemCount: provider.actList.length,
                  itemBuilder: (context, index) {
                    final data = provider.actList.elementAt(index);
                    return Padding(
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      CustomDialogBox.appDialog(
                                        context,
                                        CustomDialog(
                                          title: 'Raise ticket to Re-Tag Asset',
