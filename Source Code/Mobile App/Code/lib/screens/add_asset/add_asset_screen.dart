    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      if (widget.editAssetModel != null) {
        ...
        context.read<AddAssetProvider>().prepopulateData(
          ...
          category: widget.editAssetModel?.data?.taAssetCatagory?.toUpperCase(),
        );
      }
    });
  }
                ...
                bool shouldExit = await showDialog(
                  ...
                  builder: (BuildContext context) {
                    return CustomDialog(
                      ...
                      body: PopupBodySingleTextDialog(desc: addAssetDraftDesc),
                      footer: Row(
                    ...
                    children: [
                      ...
                      ValueListenableBuilder<Box<SingleAsset>>(
                        ...
                        builder: (context, box, child) {
                          final List<SingleAsset> draftList = box.values
                              .toList();
                                    ...
                                    AddAssetDraftWidget(
                                      ...
                                      onTap: (bean) async {
                                        await provider.prepopulateData(
                                          parentAssetId: widget.assetTypeId,
                                          result: SingleAssetModel(data: bean),
                                          addAssetScreenFrom:
                                              widget.addAssetScreenFrom,
                                          category: SingleAssetModel(data: bean)
                                              .data
                                              ?.taAssetCatagory
                                              ?.toUpperCase(),
                                        );
                                ...
                                if (provider.serialController.text.isEmpty) {
                                  ...
                                  if (result?.status ==
                                    ...
                                    provider.setCategory(
                                      ...
                                      AssetSearchStatus.dontAllowToAdd.value) {
                                    ToastMessage.showMessage(
                                      ...
                                      AssetSearchStatus
                                          .allowToAddByPrePopulating
                                          .value) {
                                    var desc = assetFoundInOtherSite;
                                    if (widget.addAssetScreenFrom ==
                                        AddAssetType
                                            .addParentFromAssetListing) {
                                      if (result?.data?.taAssetParentId == 0) {
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      PermissionManager.hasCameraPermission().then((
                                        value,
                                      ) {
                                        if (value) {
                                          CustomDialogBox.appDialog(
                                          ...
                                          PermissionManager().requestPermission(
                                            onPermissionDenied: () =>
                                                CustomDialogBox.showPermissionDialog(
                                                  _context,
                                                ),
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed:
                                        ...
                                        ? () async {
                                            ...
                                            bool isValidated = await provider
                                                .isValidated();
                                            if (isValidated) {
                            ...
                            Container(
                              ...
                              child: OutlinedButton(
                                ...
                                onPressed: () async {
                                  bool result = await provider.addAssetToBox();
                                  if (result) {
                                    Navigator.of(context).pop(true);
                                  }
                                },
