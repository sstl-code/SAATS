    ...
    <div class="tab-pane fade show active scroll_stn" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="batchSubDiv col-md-6">
                <div class="">
                    ...
                    <h6>Download Asset Audit Template:</h6>
                    <a class="btn btn-primary btn-sm" href="{{asset('assets/assets/excels/testsheet.xlsx')}}" style="border-radius: 0; background-color: #202C55;"><i class="fa-solid fa-download"></i> Click here to download the template file</a>
                </div>
                <div class="mt-3">
                    <h6>Bulk Upload:</h6>
            ...
            <a class="btn btn-primary btn-sm my-3" onclick="UploadAsset();" style="border-radius: 0; background-color: #202C55;float: right;">Upload</a>
            <?php }?>
    </div>
